...
(function () {
  ...
  style.textContent = [
    ...
    '#nk-cookie p{',
      'font-size:0.82rem;color:#3C4043;line-height:1.6;',
      'flex:1;min-width:220px;margin:0;',
    '}',
    '#nk-cookie a{color:#1A73E8;text-decoration:underline;white-space:nowrap;}',
    '#nk-cookie a:hover{color:#174EA6;}',
    ...
    '#nk-cookie-decline{background:#fff;color:#1A73E8;border:1px solid #DADCE0;}',
    '#nk-cookie-decline:hover{background:#F1F3F4;}',
